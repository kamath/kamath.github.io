...
var img = ['me1.jpg', 'neu.jpg', 'counteract.png', 'biogen.png', 'un.jpeg', 'gllass.png', 'eagle.png', 'jcl.jpg'];
var title = ['Andy Kamath', 'Education', 'CounteractIO', 'DR Research', 'Threat Protection', 'Gllass', 'Non-CS Activities', 'Non-CS Part II'];
var desc = ['Hey! I\'m an 18 year old with a strong interest in data science and full stack development.<br><br>Click the green arrow to learn more about me!',
    ...
    'Colorectal cancer doesn\'t show up on nearly 25% of prescreen tests.<br><br>What if you combined current stool tests with our patent pending softmax optimization algorithms to achieve 92% sensitivity/86% precision, while still being 96% cheaper than other tests with the same sensitivity?<br><br>Built May 2017. <a href="http://counteract.io">Check it out</a>',
    'I built a prescreening test for diabetic retinopathy using computer vision and machine learning algorithms in March 2017.<br><br>This research won me the Intel Excellence in Computer Science award, a silver medal from the US Army, the Founder\'s Award for Excellence in Public Health from the SSSI, and a 3rd place award from the NC Biogen Foundation',
    'What if there was a way to use social media analytics to detect patterns of violent behavior? Is there anything we can do about it?<br><br>I worked alongside the UN Counterterrorism Committee Executive Directorate and the Office of Information and Communications Technology to do just that. This project won the UN U4H grand award and was a national finalist in the Technology Students Association competition.<br><br>Built Fall 2016. <a href="http://github.com/counteractio/counteract">Check it out</a>.',
    ...
    'I\'m currently in the final stages of earning the Eagle Scout rank, becoming one of less than 5% of Boy Scouts who reach this achievement, demonstrating years of hard work, leadership, and service, also earning me three Presidential Volunteer Service Awards along the way for over 300 hours of service',
